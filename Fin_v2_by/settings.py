...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('MYSQL_PASSWORD', 'cbNIHjeXTCxbtwtxyqqNpuVaZtiHvYph'),
        'HOST': os.environ.get('MYSQL_HOST', 'ballast.proxy.rlwy.net'),
        'PORT': os.environ.get('MYSQL_PORT', '34897'),
    }
}
